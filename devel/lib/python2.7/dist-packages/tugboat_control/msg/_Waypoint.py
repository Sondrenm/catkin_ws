...
class Waypoint(genpy.Message):
  _md5sum = "ac21d14c0ba92bbf8f535b458744d831"
...
float64 v #Velocity in m/s"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B4d().pack(_x.ID, _x.x, _x.y, _x.theta, _x.v))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ID, _x.x, _x.y, _x.theta, _x.v,) = _get_struct_B4d().unpack(str[start:end])
      return self
