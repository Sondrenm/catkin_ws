...
gnome-terminal --geometry 60x10+0+420 -e "rosrun tugboat_control ShipControl_Generic"
gnome-terminal --geometry 60x10+0+620 -e "rosrun tugboat_control WaypointDummy"
gnome-terminal --geometry 60x10+0+820 -e "rosrun tugboat_control TugController _ID:=3"
